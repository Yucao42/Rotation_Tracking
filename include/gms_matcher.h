...
inline Mat DrawInlier(Mat &src1, Mat &src2, vector<KeyPoint> &kpt1, vector<KeyPoint> &kpt2, vector<DMatch> &inlier, int type) {
	...
	if (type == 1)
	{
		for (size_t i = 0; i < inlier.size(); count++, i++)
		{
...
//    cout << "Get total " << num_inliers << " matches." << endl;
    ...
    Mat mask;
    vector<Point2f> l,r;
    Keypoints2Points2f(kp1,kp2,matches_gms,l,r);
    Mat E = findEssentialMat(l, r, M1, RANSAC, 0.999, 0.50, mask);
    Mat R, t;
    recoverPose(E,l,r,M1, R,t);
